...
{
    public List<BaseSystem<bool>> Conditions = new ();
    public T Node;
    /// <summary>
...
public class SystemConfig : NodeConfig<BaseSystem<Empty>>, IIntoSystemConfigs
{
    public SystemConfig(BaseSystem<Empty> system) : base(system)
    {
        Subgraph.Hierarchy = system.GetDefaultSystemSets();
        Conditions = new List<BaseSystem<bool>>();
    }
