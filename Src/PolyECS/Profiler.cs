...
public static class Profiler
{
    ...
    /// </param>
    /// <returns></returns>
    public static IProfilerZone BeginZone(
        ...
        [CallerMemberName] string memberName = null)
    {
        ...
        var srcLocId =
 TracyAllocSrclocName((uint)lineNumber, filestr, fileln, memberstr, memberln, namestr, nameln, color);
