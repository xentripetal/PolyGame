...
public class RenderTexture : IDisposable
{
    ...
    /// </summary>
    public RenderTexture(GraphicsDevice device, Screen screen)
    {
        RenderTarget = new RenderTarget2D(device, screen.Width, screen.Height, false, screen.PreferredBackBufferFormat, screen.PreferredDepthStencilFormat,
