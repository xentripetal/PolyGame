...
/// <remarks>Copy of HexaEngine.Editor.HistoryContext</remarks>
public struct HistoryContext<T1, T2> : IHistoryContext<T1, T2>
{
    ...
    T1 IHistoryContext<T1, T2>.Target
    {
        get => Target;
        set => Target = value;
    }

    T2 IHistoryContext<T1, T2>.OldValue
    {
        get => OldValue;
        set => OldValue = value;
    }

    T2 IHistoryContext<T1, T2>.NewValue
    {
        get => NewValue;
        set => NewValue = value;
    }
