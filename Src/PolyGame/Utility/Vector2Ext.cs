...
public static class Vector2Ext
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Cross(Vector2 u, Vector2 v) => u.Y * v.X - u.X * v.Y;
    ...
    /// <param name="c">C.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsTriangleCCW(Vector2 a, Vector2 center, Vector2 c) => Cross(center - a, c - center) < 0;
