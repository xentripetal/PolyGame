...
public unsafe struct ImGuiFontBuilder : IDisposable
{
    ...
    public ImGuiFontBuilder AddFontFromMemoryTTF(ReadOnlySpan<byte> fontData, float size,
        ReadOnlySpan<uint> glyphRanges)
    {
